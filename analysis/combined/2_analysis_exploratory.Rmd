...
round, number_training_images, current_category_training_level, sampling_consistent_level
...
kid_participant_ages <- kid_sampling_data %>% select(participant, age_group, age_years, age_mos) %>% unique()
...
```
# are kids actually using the sampling information to make test choices
