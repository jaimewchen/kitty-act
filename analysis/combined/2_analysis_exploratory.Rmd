...
plot1 <- samptestint_choice_type_rate %>% filter(group == "1_child") %>% ggplot(aes(x = age_years, y = fa_rate)) + geom_point() + scale_y_continuous(limits=c(-0.01, 1.01))

print(plot1)

plot2 <- samptestint_choice_type_rate %>% filter(group == "2_adult") %>% ggplot(aes(x = group, y = fa_rate)) + geom_jitter() + scale_y_continuous(limits=c(-0.01, 1.01))
