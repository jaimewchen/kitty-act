...
# just adults
m <- glmer(is_chosen~sampling_feedback_c+(1+sampling_feedback_c|participant)+(1|training_condition),data=filter(combined_test_array_options_clean,match_categories=="sampled level" & sampling_choice_type == "explore"&sample_group=="adults"), family=binomial)
summary(m)
```
