...
ggplot(combined_sampling_data,aes(training_condition_ord,fill=sampled_category_level_kind_info_ord))+
...
ggplot(combined_sampling_data,aes(age_years,is_exploratory))+
...
## subordinate choices
m_sub <- lmer(prop_subordinate~training_condition+(1|participant),data=filter(subj_test_prop,sample_group=="children"))
summary(m_sub)
Anova(m_sub,type="III")

## basic choices
m_bas <- lmer(prop_basic~training_condition+(1|participant),data=filter(subj_test_prop,sample_group=="children"))
summary(m_bas)
Anova(m_bas,type="III")

## superordinate choices
m_sup <- lmer(prop_superordinate~training_condition+(1|participant),data=filter(subj_test_prop,sample_group=="children"))
summary(m_sup)
...
# fit individual lmer models
## subordinate choices
m_sub <- lmer(prop_subordinate~training_condition+(1|participant),data=filter(subj_test_prop,sample_group=="adults"))
summary(m_sub)
Anova(m_sub,type="III")
...
Exploratory: No interaction between children and adults
