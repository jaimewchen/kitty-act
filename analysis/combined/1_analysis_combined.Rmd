...
subj_test_prop <- combined_test_array_options_clean %>%
  ...
  ungroup() %>%
  group_by(sample_group,participant,number_training_images,current_category_training_level,training_condition,current_category_label_level,current_category_kind) %>%
  summarize(
