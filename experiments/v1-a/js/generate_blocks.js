...
function generate_learning_instructions(current_training_label, current_training_images, number_training_images = 3) {
  ...
  if (number_training_images == 1) {
    ...
    current_learning_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
...
function generate_check_instructions(current_training_label, current_training_images, number_training_images = 3) {
  ...
  current_learning_stimulus += '<div class="row">';
  if (number_training_images == 1) {
    current_learning_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '</div>';
    ...
    current_learning_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '<div class="column"><figure><img src="' + current_training_images[1] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '<div class="column"><figure><img src="' + current_training_images[2] + '" style="width:75%"><figcaption style="font-size:24px"></figcaption></figure></div>';
    current_learning_stimulus += '</div>';
...
function generate_sampling_instructions(current_training_label, current_training_images, number_training_images = 3) {
  ...
  if (number_training_images == 1) {
    ...
    current_sampling_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:75%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
...
function generate_selection_instructions(current_training_label, current_sampling_label, current_training_images, current_sampling_image, number_training_images = 3) {
  ...
  if (number_training_images == 1) {
    current_selection_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:100%; border: 5px solid #FFFFFF; padding: 6px"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_sampling_image + '" style="width:100%; border: 5px solid #ff0000; padding: 6px"><figcaption style="font-size:24px;color:#ff0000">' + current_sampling_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '</div class="column"></div class="column"></div class="column"></div class="column">';
  } else if (number_training_images == 3) {
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:100%; border: 5px solid #FFFFFF; padding: 6px"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_training_images[1] + '" style="width:100%; border: 5px solid #FFFFFF; padding: 6px"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_training_images[2] + '" style="width:100%; border: 5px solid #FFFFFF; padding: 6px"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_selection_stimulus += '<div class="column"><figure><img src="' + current_sampling_image + '" style="width:100%; border: 5px solid #ff0000; padding: 6px"><figcaption style="font-size:24px;color:#ff0000">' + current_sampling_label + '</figcaption></figure></div class="column"></div class="column"></div class="column"></div class="column">';
  }
...
function generate_test_instructions(current_training_label, current_sampling_label, current_training_images, current_sampling_image, number_training_images = 3) {
  ...
  if (number_training_images == 1) {
    current_test_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure><img src="' + current_sampling_image + '" style="width:100%"><figcaption style="font-size:24px">' + current_sampling_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure style="opacity:0"><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '</div class="column"></div class="column"></div class="column"></div class="column">';
  } else if (number_training_images == 3) {
    current_test_stimulus += '<div class="column"><figure><img src="' + current_training_images[0] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure><img src="' + current_training_images[1] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure><img src="' + current_training_images[2] + '" style="width:100%"><figcaption style="font-size:24px">' + current_training_label + '</figcaption></figure></div>';
    current_test_stimulus += '<div class="column"><figure><img src="' + current_sampling_image + '" style="width:100%"><figcaption style="font-size:24px">' + current_sampling_label + '</figcaption></figure></div class="column"></div class="column"></div class="column"></div class="column">';
