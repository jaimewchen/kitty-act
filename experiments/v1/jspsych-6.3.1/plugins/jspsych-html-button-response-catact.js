 ...
 jsPsych.plugins["html-button-response-catact"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function toggle_response(choice) {
      ...
      if (document.getElementById('jspsych-html-button-response-button-'+choice).style.color=="salmon") {
        ...
        document.getElementById('jspsych-html-button-response-button-'+choice).style.color="salmon";
