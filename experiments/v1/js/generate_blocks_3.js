...
function generate_learning_instructions_pre(current_training_label, current_training_images) {
  ...
  current_learning_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple; background-color:rgba(255,255,255,.5)"><img src="'+current_training_images[0]+'" class="fade-in" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px; opacity:0"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
...
function generate_sampling_instructions_hidden(current_training_label, current_training_images, shuffled_sampling_images) {
  ...
  current_sampling_stimulus_hidden += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[0]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_sampling_stimulus_hidden += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[1]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_sampling_stimulus_hidden += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[2]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div></div>';
...
function generate_sampling_instructions(current_training_label, current_training_images) {
  ...
  current_sampling_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[0]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_sampling_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[1]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_sampling_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[2]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
...
function generate_selection_instructions_big(current_training_label, current_sampling_label,current_training_images,current_sampling_image) {
  ...
  current_selection_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[0]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_selection_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[1]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_selection_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[2]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div></div>';
  current_selection_stimulus += (current_sampling_label === current_training_label) ? '<div class="column"><figure><img src="'+current_sampling_image+'" style="width:30%; border: 5px solid purple;"><figcaption style="font-size:24px; color:white; margin-top:10px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div></div>' : '<div class="column"><figure><img src="'+current_sampling_image+'" style="width:30%; border: 5px solid #ffa500;"><figcaption style="font-size:24px; color:white; margin-top:10px;"><span style="background-color:white; border: 3px solid #ffa500;"><b>-<span style="color:#ffa500">not '+current_training_label+'</span>-</b></span></figcaption></figure></div></div>' ;
...
function generate_selection_instructions(current_training_label, current_sampling_label,current_training_images,current_sampling_image) {
  ...
  current_selection_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[1]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_selection_stimulus+= '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[2]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_selection_stimulus += (current_sampling_label === current_training_label) ? '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_sampling_image+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div></div></div>' : '<div class="column"><figure><figure style="border: 3px solid #ffa500;"><img src="'+current_sampling_image+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid #ffa500;"><b>-<span style="color:#ffa500">not '+current_training_label+'</span>-</b></span></figcaption></figure></div></div>' ;
  return(current_selection_stimulus)
}
...
function generate_pre_test_instructions(current_training_label, current_sampling_label,current_training_images,current_sampling_image,cur_test_image) {
  ...
  current_test_stimulus += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[0]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_test_stimulus += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[1]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
  current_test_stimulus += '<div class="column"><figure><figure style="border: 3px solid purple;"><img src="'+current_training_images[2]+'" style="width:100%; margin-bottom:-7px;"></figure><figcaption style="font-size:24px; color:white; margin-top:15px;"><span style="background-color:white; border: 3px solid purple;"><b>-<span style="color:purple">'+current_training_label+'</span>-</b></span></figcaption></figure></div>';
